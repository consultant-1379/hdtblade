...
else if (A_DAE > 55 && A_DAE <= 80) {
	DAE_IO = 11;
} 
else if (A_DAE > 80 && A_DAE <= 135) {
	DAE_IO = 12;
}
else if (A_DAE > 135 && A_DAE <= 150) {
	DAE_IO = 13;
}
else if (A_DAE > 150 && A_DAE <= 160) {
	DAE_IO = 14;
}
else if (A_DAE > 160 && A_DAE <= 180) {
	DAE_IO = 15;
}
else if (A_DAE > 180 && A_DAE <= 210) {
	DAE_IO = 16;
