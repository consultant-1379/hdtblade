...
else if (A_DAE > 38 && A_DAE <= 40) {
	DAE_IO = 2;
} 
else if (A_DAE > 40 && A_DAE <= 43) {
	DAE_IO = 3;
}
else if (A_DAE > 43 && A_DAE <= 120) {
	DAE_IO = 4;
}
...
else if (A_DAE > 38 && A_DAE <= 45) {
	DAE_IO = 11;
} 
else if (A_DAE > 45 && A_DAE <= 90) {
	DAE_IO = 12;
}
