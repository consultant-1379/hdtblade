...
//Half Height for Presentation small config.
 if (typeof(PRESENTATION_APP901421_QTY) == 'undefined') {
	HDT_THIS.addAPPDependency('PRESENTATION', 'APP901421');
	unresolved_dependency = 'true';
} else {
	if (PRESENTATION_APP901421_QTY != -1.0) {
		sum_half += PRESENTATION_APP901421_QTY;
	}
}

//Half Height for Mediation small config.
 if (typeof(MEDIATION_APP901421_QTY) == 'undefined') {
	HDT_THIS.addAPPDependency('MEDIATION', 'APP901421');
	unresolved_dependency = 'true';
} else {
	if (MEDIATION_APP901421_QTY != -1.0) {
		sum_half += MEDIATION_APP901421_QTY;
	}
}

//Half Height for COORDINATOR small config.
 if (typeof(COORDINATOR_APP901421_QTY) == 'undefined') {
	HDT_THIS.addAPPDependency('COORDINATOR', 'APP901421');
	unresolved_dependency = 'true';
} else {
	if (COORDINATOR_APP901421_QTY != -1.0) {
		sum_half += COORDINATOR_APP901421_QTY;
	}
}

//Half Height for IQSERVER small config.
 if (typeof(IQSERVER_APP901421_QTY) == 'undefined') {
	HDT_THIS.addAPPDependency('IQSERVER', 'APP901421');
	unresolved_dependency = 'true';
} else {
	if (IQSERVER_APP901421_QTY != -1.0) {
		sum_half += IQSERVER_APP901421_QTY;
	}
}

//Half Height for OMBS small config.
 if (typeof(OMBS_APP901421_QTY) == 'undefined') {
	HDT_THIS.addAPPDependency('OMBS', 'APP901421');
	unresolved_dependency = 'true';
} else {
	if (OMBS_APP901421_QTY != -1.0) {
		sum_half += OMBS_APP901421_QTY;
	}
}

//Half Height for OMBS medium config.
 if (typeof(OMBS_APP901421_QTY) == 'undefined') {
	HDT_THIS.addAPPDependency('OMBS', 'APP901421');
	unresolved_dependency = 'true';
} else {
...
//Half Height for Presentation medium config.
 if (typeof(PRESENTATION_APP901515_QTY) == 'undefined') {
	HDT_THIS.addAPPDependency('PRESENTATION', 'APP901515');
	unresolved_dependency = 'true';
} else {
	if (PRESENTATION_APP901515_QTY != -1.0) {
		sum_half += PRESENTATION_APP901515_QTY;
	}
}

//Half Height for Mediation medium config.
 if (typeof(MEDIATION_APP901515_QTY) == 'undefined') {
	HDT_THIS.addAPPDependency('MEDIATION', 'APP901515');
	unresolved_dependency = 'true';
} else {
	if (MEDIATION_APP901515_QTY != -1.0) {
		sum_half += MEDIATION_APP901515_QTY;
	}
}

//Half Height for COORDINATOR medium config.
 if (typeof(COORDINATOR_APP901515_QTY) == 'undefined') {
	HDT_THIS.addAPPDependency('COORDINATOR', 'APP901515');
	unresolved_dependency = 'true';
} else {
	if (COORDINATOR_APP901515_QTY != -1.0) {
		sum_half += COORDINATOR_APP901515_QTY;
	}
}

//Half Height for IQSERVER medium config.
 if (typeof(IQSERVER_APP901515_QTY) == 'undefined') {
	HDT_THIS.addAPPDependency('IQSERVER', 'APP901515');
	unresolved_dependency = 'true';
} else {
	if (IQSERVER_APP901515_QTY != -1.0) {
		sum_half += IQSERVER_APP901515_QTY;
	}
}
