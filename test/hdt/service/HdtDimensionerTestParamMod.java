...
public class HdtDimensionerTestParamMod extends BaseHdtTest {
    ...
    public HdtDimensionerTestParamMod() {
    }
    ...
    public void testDimensioner() throws ScriptException {
        ...
        //Bundle b = new Bundle("LARGE", "Large Bundle");
        ...
        myLogger.log(LogLevel.MAIN, "Main Dimensioning Parameters: " + mainDimInpParList);
        ...
        dimensioner.changeParameter(true, "LR_NODE", "ADMIN", "4000");
