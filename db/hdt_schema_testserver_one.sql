-- hdt_schema_testserver.sql
-- This creates the testserver 2 HDT database schema.
-- FIXME: The Version should come from CVS.
--
-- USED FOR THE LIVE SERVER.
--
-- Author: Ralph Schlosser
-- Version: 1.3
-- Date: 22/10/2010
-- Last Change: 13/07/2011

DROP DATABASE IF EXISTS `hdt_testserver_one`;

CREATE DATABASE `hdt_testserver_one`;
USE `hdt_testserver_one`;
...
CREATE TABLE `hdtconfiguration` (
    `hdtversion` CHAR(10) NOT NULL DEFAULT '',
    `dbversion` CHAR(10) NOT NULL DEFAULT '',
    PRIMARY KEY(`hdtversion`)
 )
ENGINE = MYISAM
ROW_FORMAT = FIXED;
...
CREATE TABLE `variable_formula` (    
    ...
    `test_variable_context` CHAR(50) NOT NULL DEFAULT '',    
    `role_name` CHAR(50) NOT NULL DEFAULT '',
    `network_name` CHAR(50) NOT NULL DEFAULT '',
    `system_name` CHAR(50) NOT NULL DEFAULT ''
)
...
CREATE TABLE `peer_server_hw_config` (
    `PEER_SERVER_CPU` DOUBLE DEFAULT 0.0,
    `PEER_SERVER_MEM` DOUBLE DEFAULT 0.0,
    `PEER_SERVER_IO` DOUBLE DEFAULT 0.0,
    `test_variable_context` CHAR(50) NOT NULL DEFAULT '',
    `hw_config_name` CHAR(50) NOT NULL DEFAULT '',
    `hw_config_revision` INT DEFAULT 1,
    `hw_config_status` INT DEFAULT 0
...
CREATE TABLE `streaming_hw_config` (
    `STREAMING_CPU` DOUBLE DEFAULT 0.0,
    `STREAMING_MEM` DOUBLE DEFAULT 0.0,
    `STREAMING_IO` DOUBLE DEFAULT 0.0,
    `test_variable_context` CHAR(50) NOT NULL DEFAULT '',
    `hw_config_name` CHAR(50) NOT NULL DEFAULT '',
    `hw_config_revision` INT DEFAULT 1,
    `hw_config_status` INT DEFAULT 0
